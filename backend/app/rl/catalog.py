...
ALGORITHM_CATALOG: dict[str, dict[str, Any]] = {
    ...
    "dqn": {
        ...
        "description": "Value-based baseline over 27 auditable resource-allocation presets.",
    ...
    "mpc": {
        ...
        "description": "Three-step finite-horizon model-predictive control with a constrained beam search over 27 actions.",
