...
面向港口岸电、装卸资源与储能协同配置，自研
`PortEnergyDispatchEnv-v1`：以当前/未来 3 小时需求、碳强度、电价、积压、电网
余量、SOC、时段和货类结构构成 19 维观测，使用岸电、岸桥、场内车辆及储能
4 维连续动作（DQN 为 81 个离散组合），支持 PPO、SAC、TD3、DQN 与四步约束
MPC 同环境训练评测。
...
| 19 observations, four continuous controls, 81 DQN actions | supported | environment spaces and encoder tests |
