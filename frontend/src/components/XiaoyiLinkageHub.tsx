...
const rlAlgorithms: RlAlgorithmOption[] = [
  {
    ...
    description: '控制理论基线：三步有限时域内对 27 个可行资源组合做约束束搜索，不拟合神经网络。',
  ...
  },
  {
    ...
    label: 'DQN',
    tag: 'Discrete',
    description: '离散动作强化学习：在岸电、岸桥和堆场资源的 27 个组合中学习 Q 值。',
...
const trainingDataFiles: TrainingDataFile[] = [
  { id: 'port_la_2025_monthly', label: '洛杉矶港 2025 公开基准', path: 'port_la_2025_monthly', description: '洛杉矶港月度 TEU 统计 + 美国环保署 eGRID CAMX 排放因子；1–9 月训练，10–12 月测试。' },
];
