...
from app.schemas.operations_energy_planning import (  # noqa: E402
    OperationsEnergyPlanningRequest,
    SOURCE_DOMAINS,
)
from app.services.operations_energy_planning import (  # noqa: E402
    canonical_sha256,
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Sign exactly one source domain in a complete operations-energy "
            "planning request with its source owner's Ed25519 private key."
        )
    )
    parser.add_argument("--input", required=True, help="Complete planning request JSON")
    ...
    parser.add_argument("--output", required=True, help="Updated planning request JSON")
